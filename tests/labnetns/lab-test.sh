...
OPEN_SURGE_SMARTDNS_INTEGRATION_TESTS=1 "$SMARTDNS_TEST_BIN" \
  -test.v -test.run '^TestRenderedConfigLoadsInPinnedSmartDNSlog "creating isolated client -> gateway -> upstream topology"
